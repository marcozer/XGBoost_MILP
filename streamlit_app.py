...
def main() -> None:
    ...
    st.title("Best Performer Predictor after Mini-Invasive Left Pancreatectomy")
    st.write(
            "Prediction of the composite outcome : absence of mortality, severe complications (Clavien-Dindo ≥3), postoperative pancreatic fistula (ISGPS grade B/C), reoperation, readmission, and length of stay ≤ 25th percentile using the published XGBoost model based on the French multicentric cohort of the AFC (Association Française de Chirurgie)"
    )
